...
<svelte:head>
    <title>Day2</title>
    <meta name="description" content="Day 2: Rock Paper Scissors" />
</svelte:head>
...
<div class="text-column">
    ...
    {#if visible} 
        <p>
            Following this strategy will result in a score of {score}.<br>
            Following the updated strategy will result in a score of {newScore}.
        </p>
    {/if}
</div>
